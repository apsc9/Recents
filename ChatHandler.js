...
const chat_names = ["Rajiv", "Ankit Sharma", "Abhishek", "Aditya kunwar", "Nidhii", "Rajul", "Rachit Jain"];
const chat_names_length = chat_names.length;
const chat_msg = ["She should have come and talked to me...",
    "That's My Bro , congo and cheers to the new beginnings...",
    "What you are telling me to do isnt apt..",
